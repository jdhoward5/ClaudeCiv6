...
* https://github.com/Wild-W/CivilizationVI_CommunityExtension/blob/master/HavokScript.h
**/
...
namespace hks {
	...
	typedef void(__cdecl* hksi_lua_pushstringType)(hks::lua_State*, const char*);
	extern hksi_lua_pushstringType pushstring;
	typedef void(__cdecl* hksi_lua_pushlstringType)(hks::lua_State*, const char*, size_t);
	extern hksi_lua_pushlstringType pushlstring;
